...
const tuNombre = "Alvaro";
createdBy.innerHTML += " " + tuNombre;
...
function displayToDos() {
  ...
  const toDoObjects = buildToDos(toDoItems);
  toDoObjects.forEach((toDoElement) => {
...
function addToDo() {
  ...
  const newToDoDescription = toDoInput.value;
  const newToDo = new ToDo(newToDoDescription);
